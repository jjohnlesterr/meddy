...
const styles = StyleSheet.create({
  ...
  headingCopy: { flex: 1 },
  name: { color: Palette.text, fontSize: 19, lineHeight: 25, fontWeight: '800' },
  details: { color: Palette.textSecondary, fontSize: 14, lineHeight: 20, marginTop: 3 },
  ...
  statusText: { color: '#3E8057', fontSize: 12, lineHeight: 16, fontWeight: '800' },
  inactiveStatusText: { color: Palette.textSecondary },
  scheduleRow: { minHeight: 36, flexDirection: 'row', alignItems: 'center', marginTop: 11 },
  clock: { color: Palette.strongPink, fontSize: 20, marginRight: 7 },
  time: { flex: 1, color: Palette.text, fontSize: 16, lineHeight: 22, fontWeight: '800' },
  chevron: { color: Palette.strongPink, fontSize: 27, lineHeight: 28 },
  instructions: { color: Palette.textSecondary, fontSize: 14, lineHeight: 20, marginTop: 5 },
