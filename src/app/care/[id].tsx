...
const styles = StyleSheet.create({
  ...
  errorText: { color: Palette.danger, fontSize: 15, lineHeight: 22, textAlign: 'center' },
  retryButton: { minHeight: 46, marginTop: 4 },
  inlineError: { color: Palette.danger, backgroundColor: '#FFF4F4', borderRadius: 14, padding: 13, fontSize: 14, lineHeight: 20, marginBottom: 14 },
  ...
  moreText: { color: Palette.text, fontSize: 28, lineHeight: 28, fontWeight: '800', marginTop: -8 },
  ...
  tabText: { color: Palette.textSecondary, fontSize: 14, lineHeight: 19, fontWeight: '700' },
  selectedTabText: { color: Palette.strongPink, fontWeight: '800' },
  ...
  sectionTitle: { color: Palette.text, fontSize: 21, lineHeight: 27, fontWeight: '800', marginBottom: 14 },
  sectionMeta: { color: Palette.textSecondary, fontSize: 13, lineHeight: 18, marginTop: 2 },
  ...
  emptyText: { color: Palette.textSecondary, fontSize: 15, lineHeight: 22, marginTop: 5 },
  list: { gap: 10 },
  permissionNote: { color: Palette.textSecondary, fontSize: 13, lineHeight: 19, textAlign: 'center', marginTop: 14 },
  ...
  avatarText: { color: Palette.strongPink, fontSize: 17, fontWeight: '800' },
  memberCopy: { flex: 1, marginLeft: 12 },
  memberName: { color: Palette.text, fontSize: 16, lineHeight: 22, fontWeight: '800' },
  memberRole: { color: Palette.textSecondary, fontSize: 13, lineHeight: 18, marginTop: 3 },
  ...
  rejectText: { color: Palette.textSecondary, fontSize: 14, fontWeight: '800' },
  ...
  acceptText: { color: Palette.white, fontSize: 14, fontWeight: '800' },
  ...
  activityText: { color: Palette.text, fontSize: 15, lineHeight: 22, fontWeight: '700' },
  activityTime: { color: Palette.textSecondary, fontSize: 12, lineHeight: 17, marginTop: 4 },
  ...
  menuTitle: { color: Palette.textSecondary, fontSize: 12, lineHeight: 17, fontWeight: '800', letterSpacing: 0.8, paddingHorizontal: 12, paddingVertical: 8 },
  menuOption: { minHeight: 50, justifyContent: 'center', borderRadius: 14, paddingHorizontal: 13 },
  menuOptionText: { color: Palette.text, fontSize: 16, lineHeight: 22, fontWeight: '700' },
  ...
  modalTitle: { color: Palette.text, fontSize: 23, lineHeight: 30, fontWeight: '800', textAlign: 'center' },
  inviteCode: { color: Palette.strongPink, fontSize: 28, lineHeight: 36, fontWeight: '800', letterSpacing: 1.5, textAlign: 'center', marginTop: 18 },
  modalText: { color: Palette.textSecondary, fontSize: 15, lineHeight: 23, textAlign: 'center', marginTop: 9 },
